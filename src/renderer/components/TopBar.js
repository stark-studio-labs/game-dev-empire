    ...
    <div className="glass-card topbar">
      <div className="topbar__inner">
        ...
        <div className="topbar__icons">
          ...
          {/* Handbook (book icon — always unlocked) */}
          <div className="topbar__icon-wrap">
            <button
              className={`speed-btn${showHandbook ? ' active' : ''}`}
            ...
            <span className="topbar__tooltip">Game Design Handbook</span>
          </div>
